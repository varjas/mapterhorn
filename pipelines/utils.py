...
# group source items by maxzoom and dataset_id
def get_grouped_source_items(filepath):
    ...
    line_tuples = []
    for line in lines:
        source, filename, maxzoom, dataset_id = line.strip().split(',')
        maxzoom = int(maxzoom)
        line_tuples.append((
            -maxzoom,
            dataset_id,
    ...
    current_group = [{
        ...
        'dataset_id': first_line_tuple[1],
        'source': first_line_tuple[2],
